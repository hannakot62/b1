export default function GoldMedalIcon() {
    return (
        <svg viewBox="0 0 120 120" id="Layer_1" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
            ...
            <g id="SVGRepo_iconCarrier">
                <g> <polygon className="st0" style={{fill: "#E24255"}}
                             points="79.7,45.6 60,55.5 40.3,45.6 15.9,94.3 31.1,92.8 38.9,105.9 60,63.9 81.1,105.9 88.9,92.8 104.1,94.3 "></polygon>
                    <circle className="st1" style={{fill: "#FFC54D"}} cx="60" cy="46.4" r="32.2"></circle>
                    <circle className="st2" style={{fill: "#E8B04B"}} cx="60" cy="46.4" r="25.3"></circle>
